...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0158cc64-198c-4565-af6d-9dcb9c0acb61
```

> `0158cc64-198c-4565-af6d-9dcb9c0acb61` is the password of the certificate, you can change it to any password you want.
